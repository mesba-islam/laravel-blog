        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input name="blog_title" value="{{ $blogs->blog_title }}" class="form-control" type="text" placeholder="example..." id="example-text-input">
                ...
                <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <textarea id="elm1" name="blog_description"  aria-hidden="true"> {{ $blogs->blog_description }}</textarea>
                        </div>
                ...
                <input type="submit" class="btn btn-info waves-effect wave-light" value=" Update ">
                </form>
            </div>
        </div>
    </div> <!-- end col -->
...
$(document).ready(function(){
    $('#image').change(function(e){
        ...
        reader.reasAsDataURL(e.target.files[['0']]);
    });
});
</script>
